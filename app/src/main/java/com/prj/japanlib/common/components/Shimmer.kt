...
/**
 * A Composable Modifier extension that applies a shimmering effect to any component.
 *
 * This modifier is used to indicate a loading state by drawing a shimmering gradient
 * over the component's content area.
 *
 */
@Composable
